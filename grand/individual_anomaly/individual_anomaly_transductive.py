...
class IndividualAnomalyTransductive:
    ...
    def __init__(self,dynamic_threshold=False, dynamic_error_presentage=0.005, historic_errors=60, w_martingale=15, non_conformity="median", k=20, dev_threshold=0.6, ref_group=["season-of-year"],
